...
Full code for connection setup, retry logic, repository patterns, transactions, pagination, and dependency injection.
...
For sqlx, see [references/sqlx-patterns.md](sqlx-patterns.md#connection-setup).
...
For full GORM patterns (models, soft deletes, preloading, transactions, hooks): see [references/gorm-patterns.md](gorm-patterns.md).
...
For full sqlx patterns (struct scanning, NamedExec, IN clauses, transactions): see [references/sqlx-patterns.md](sqlx-patterns.md).
...
See [Cursor Pagination in GORM Patterns](gorm-patterns.md#cursor--keyset-pagination) for implementation.
